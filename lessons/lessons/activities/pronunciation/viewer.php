...
<style>
*{box-sizing:border-box}html,body{width:100%;min-height:100%}body{margin:0!important;padding:0!important;background:#ffffff!important;font-family:'Nunito','Segoe UI',sans-serif!important}.activity-wrapper{max-width:100%!important;margin:0!important;padding:0!important;min-height:100vh;display:flex!important;flex-direction:column!important;background:transparent!important}.top-row{display:none!important}.viewer-content{flex:1!important;display:flex!important;flex-direction:column!important;padding:0!important;margin:0!important;background:transparent!important;border:none!important;box-shadow:none!important;border-radius:0!important}
.pron-shell{width:100%;min-height:calc(100vh - 90px);padding:clamp(14px,2.5vw,34px);display:flex;align-items:flex-start;justify-content:center;background:#ffffff;font-family:'Nunito','Segoe UI',sans-serif}.pron-app{width:min(820px,100%);margin:0 auto}.pron-board{width:min(760px,100%);margin:0 auto;background:#ffffff;border:1px solid #F0EEF8;border-radius:34px;padding:clamp(16px,2.6vw,26px);box-shadow:0 8px 40px rgba(127,119,221,.13)}.pron-header{text-align:center;margin-bottom:14px}.pron-kicker{display:inline-flex;align-items:center;justify-content:center;margin-bottom:8px;padding:7px 14px;border-radius:999px;background:#FFF0E6;border:1px solid #FCDDBF;color:#C2580A;font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.08em}.pron-title{margin:0;font-family:'Fredoka','Trebuchet MS',sans-serif;font-size:clamp(30px,5.5vw,58px);line-height:1.03;color:#F97316;font-weight:700}.pron-subtitle{margin:8px 0 0;color:#9B94BE;font-size:clamp(13px,1.8vw,17px);font-weight:800}.pron-progress{display:flex;align-items:center;gap:10px;margin-bottom:16px}.pron-track{flex:1;height:12px;background:#F4F2FD;border:1px solid #E4E1F8;border-radius:999px;overflow:hidden}.pron-fill{height:100%;width:0%;background:linear-gradient(90deg,#F97316,#7F77DD);border-radius:999px;transition:width .45s ease}.pron-count{min-width:74px;text-align:center;padding:7px 11px;border-radius:999px;background:#7F77DD;color:#ffffff;font-size:12px;font-weight:900}.pron-card{min-height:260px;border:1px solid #EDE9FA;border-radius:30px;background:#ffffff;padding:22px 18px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;box-shadow:0 8px 24px rgba(127,119,221,.09)}.pron-listen-cue{display:inline-flex;align-items:center;justify-content:center;margin-bottom:12px;padding:6px 13px;border-radius:999px;background:#EEEDFE;color:#534AB7;font-size:12px;font-weight:900}.pron-image{width:96px;height:96px;margin-bottom:13px;border-radius:18px;background:#ffffff;border:1px solid #EDE9FA;display:flex;align-items:center;justify-content:center;overflow:hidden}.pron-image img{max-width:86%;max-height:86%;object-fit:contain;display:block}.pron-placeholder{font-family:'Fredoka',sans-serif;font-size:44px;color:#CECBF6;font-weight:700}.pron-word{max-width:560px;font-family:'Nunito','Segoe UI',sans-serif;font-size:clamp(16px,2.4vw,24px);font-weight:800;line-height:1.25;color:#9B94BE;overflow-wrap:anywhere}.pron-phonetic{display:none;margin-top:8px;padding:5px 11px;border-radius:999px;background:#EEEDFE;border:1px solid #EDE9FA;color:#9B94BE;font-size:12px;font-weight:800}.pron-box{width:100%;max-width:560px;margin-top:8px;border-radius:12px;padding:9px 12px;font-size:13px;font-weight:800;text-align:center}.pron-box:empty{display:none}.pron-captured{border:1px solid #EDE9FA;background:#ffffff;color:#534AB7}.pron-captured.ok{border-color:#EDE9FA;background:#EEEDFE;color:#534AB7}.pron-captured.bad{border-color:#FCDDBF;background:#FFF0E6;color:#C2580A}.pron-answer{display:none;border:1px solid #EDE9FA;background:#ffffff;color:#9B94BE}.pron-answer.show{display:block}.pron-feedback{color:#9B94BE}.pron-feedback.bad{color:#C2580A}.pron-actions{display:flex;justify-content:center;align-items:center;gap:10px;flex-wrap:wrap;margin-top:16px;padding-top:16px;border-top:1px solid #F0EEF8}.pron-btn{border:0;border-radius:999px;min-width:clamp(104px,16vw,146px);padding:13px 20px;color:#ffffff;font-family:'Nunito',sans-serif;font-size:13px;font-weight:900;cursor:pointer;box-shadow:0 6px 18px rgba(127,119,221,.18);transition:filter .15s,transform .15s}.pron-btn:hover{filter:brightness(1.07);transform:translateY(-1px)}.pron-btn:disabled{opacity:.55;cursor:not-allowed;transform:none;filter:none}.pron-purple{background:#7F77DD;box-shadow:0 6px 18px rgba(127,119,221,.18)}.pron-orange{background:#F97316;box-shadow:0 6px 18px rgba(249,115,22,.22)}.pron-completed{display:none;width:min(760px,100%);margin:0 auto;background:#ffffff;border:1px solid #F0EEF8;border-radius:34px;box-shadow:0 8px 40px rgba(127,119,221,.13);min-height:300px;padding:34px 22px;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:12px}.pron-completed.active{display:flex}.pron-done-icon{font-size:42px;line-height:1;color:#7F77DD}.pron-done-title{margin:0;font-family:'Fredoka',sans-serif;font-size:clamp(30px,5.5vw,58px);color:#F97316;line-height:1.03;font-weight:700}.pron-done-text{margin:0;max-width:520px;color:#9B94BE;font-size:clamp(13px,1.8vw,17px);font-weight:800;line-height:1.5}.pron-score{margin:0;color:#534AB7;font-size:15px;font-weight:900}.pron-done-track{height:12px;width:min(420px,100%);border-radius:999px;background:#F4F2FD;border:1px solid #E4E1F8;overflow:hidden}.pron-done-fill{height:100%;width:0%;background:linear-gradient(90deg,#F97316,#7F77DD);transition:width .8s ease}body.embedded-mode .pron-shell,body.fullscreen-embedded .pron-shell,body.presentation-mode .pron-shell{position:absolute!important;inset:0!important;overflow-y:auto!important;overflow-x:hidden!important;padding:10px 12px!important}@media(max-width:640px){.pron-shell{padding:12px}.pron-board{padding:14px;border-radius:26px}.pron-card{min-height:240px;padding:16px;border-radius:24px}.pron-image{width:78px;height:78px}.pron-placeholder{font-size:34px}.pron-word{font-size:clamp(15px,4.8vw,20px)}.pron-actions{display:grid;grid-template-columns:1fr;gap:9px}.pron-btn{width:100%}}
</style>

<div class="pron-shell"><div class="pron-app"><section class="pron-board" id="pron-board"><div class="pron-header"><div class="pron-kicker">Activity <span id="pron-kicker-count">1 / <?php echo count($items); ?></span></div><h1 class="pron-title"><?php echo htmlspecialchars($viewerTitle, ENT_QUOTES, 'UTF-8'); ?></h1><p class="pron-subtitle">Listen carefully. Then repeat what you hear.</p></div><div class="pron-progress"><div class="pron-track"><div class="pron-fill" id="pron-progress-fill"></div></div><div class="pron-count" id="pron-progress-count">1 / <?php echo count($items); ?></div></div><div class="pron-card"><div class="pron-listen-cue">Listen first</div><div class="pron-image"><img id="pron-img" src="" alt="" style="display:none;"><div class="pron-placeholder" id="pron-placeholder">A</div></div><div class="pron-word" id="pron-word"></div><div class="pron-phonetic" id="pron-phonetic"></div><div class="pron-box pron-captured" id="pron-captured"></div><div class="pron-box pron-answer" id="pron-answer"></div><div class="pron-box pron-feedback" id="pron-feedback"></div></div><div class="pron-actions"><button type="button" class="pron-btn pron-purple" id="pron-listen">Listen</button><button type="button" class="pron-btn pron-purple" id="pron-speak">Repeat</button><button type="button" class="pron-btn pron-purple" id="pron-show">Show Text</button><button type="button" class="pron-btn pron-orange" id="pron-next">Next</button></div></section><section class="pron-completed" id="pron-completed"><div class="pron-done-icon">Done</div><h2 class="pron-done-title" id="pron-completed-title">All Done!</h2><p class="pron-done-text" id="pron-completed-text">Great job practicing pronunciation.</p><p class="pron-score" id="pron-score-text"></p><div class="pron-done-track"><div class="pron-done-fill" id="pron-done-fill"></div></div><div class="pron-actions"><button type="button" class="pron-btn pron-orange" id="pron-restart">Restart</button><button type="button" class="pron-btn pron-purple" onclick="history.back()">Back</button></div></section></div></div>
