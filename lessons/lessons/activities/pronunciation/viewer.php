...
.pron-image{width:100%;max-width:560px;height:300px;margin-bottom:14px;border-radius:24px;background:#ffffff;border:1px solid #EDE9FA;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:10px}
...
.pron-card.text-only .pron-image{height:320px;background:#FAFAFD;border-color:#ECE9FA}
.pron-card.text-only .pron-placeholder{font-size:clamp(30px,5.2vw,56px);color:#534AB7;max-width:100%}
.pron-card.text-only .pron-word{font-size:clamp(30px,5.4vw,52px)}

.pron-phonetic{display:none;margin-top:10px;padding:5px 11px;border-radius:999px;background:#EEEDFE;border:1px solid #EDE9FA;color:#9B94BE;font-size:12px;font-weight:800}
...
@media(max-width:640px){
    ...
    .pron-image{height:250px;border-radius:20px}
