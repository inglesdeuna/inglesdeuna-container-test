...
<?php if ($hasQuiz) { ?>
<div class="vtc-layout vc-layout vc-activity" id="vc-activity"><section class="vc-panel vtc-video-col"><div class="vc-video-wrap"><iframe class="vc-video" src="<?= htmlspecialchars($iframeUrl, ENT_QUOTES, 'UTF-8') ?>" title="Video comprehension" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe></div></section><section class="vc-panel vtc-content-col"><div class="vc-panel-header"><strong>Comprehension Questions</strong></div><div id="vc-quizShell" data-az-zoom><div class="vc-questions"><div class="vc-question-count" id="vc-count"></div><div class="vc-question" id="vc-question"></div><div class="vc-options" id="vc-options"></div></div><div class="vc-controls"><button type="button" class="vc-btn vc-btn-prev" id="vc-prev">← Prev</button><button type="button" class="vc-btn vc-btn-check" id="vc-show">Show Answer</button><button type="button" class="vc-btn vc-btn-next" id="vc-next">Next</button></div><div class="vc-feedback" id="vc-feedback"></div></div></section></div>
