...
// Map voice labels to ElevenLabs voice IDs
$voiceMap = [
    'josh'  => 'nzFihrBIvB34imQBuxub',
    'lily'  => 'NoOVOzCQFLOvtsMoNcdT',
    'candy' => 'Nggzl2QAXh3OijoXD116',
];
...
if (!isset($voiceMap[$voiceLabel])) {
    http_response_code(400);
    header('Content-Type: application/json');
    echo json_encode(['error' => 'Invalid voice']);
    exit;
}

$voiceId = $voiceMap[$voiceLabel];
