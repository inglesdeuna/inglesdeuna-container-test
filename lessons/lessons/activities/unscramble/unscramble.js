document.addEventListener('DOMContentLoaded', function () {
  ...
  if (!document.getElementById('us-feedback-css')) {
    ...
    st.textContent =
      '.us-answer-word--correct{background:#f0fdf4!important;border-color:#22c55e!important;color:#166534!important}' +
      '.us-answer-word--wrong{background:#fef2f2!important;border-color:#ef4444!important;color:#991b1b!important}' +
      '.us-answer-word--revealed{background:#EDE9FA;color:#7F77DD;border-radius:8px;padding:6px 12px;font-weight:700;font-family:"Nunito",sans-serif}';
