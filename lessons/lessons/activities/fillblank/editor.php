    ...
    <div class="fb-section">
        ...
        <div class="fb-section-body">
            <p class="fb-help" style="margin-bottom:12px">
                Each block = one screen. Count of <code>___</code> must equal count of comma-separated answers.
            </p>
        ...
        div.innerHTML =
            ...
            '<div class="fb-field">' +
                ...
                '<input class="fb-input" type="text" name="answers[]"' +
                    ...
                    ' required placeholder="e.g. runs, every morning">' +
            '</div>' +
...
document.getElementById('fbEditorForm').addEventListener('submit', function(e) {
    ...
    for (var i = 0; i < cards.length; i++) {
        ...
        var answers = cards[i].querySelector('input[name="answers[]"]').value
