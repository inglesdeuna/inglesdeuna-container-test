...
if($qType==='drag_drop_kids'){require __DIR__.'/_quiz_drag_drop_kids_injector.php';return;}
...
window.FILLBLANK_VOICE_ID=<?=json_encode($fbVoiceId)?>;window.FILLBLANK_TTS_URL='/lessons/lessons/activities/fillblank/tts.php';
