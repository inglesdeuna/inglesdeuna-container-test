...
?>
<style>
.qzpron-holder{width:min(760px,100%);margin:36px auto 0;font-family:'Nunito','Segoe UI',sans-serif}.qzpron-board{background:#fff;border:1px solid #F0EEF8;border-radius:34px;padding:clamp(16px,2.6vw,26px);box-shadow:0 8px 40px rgba(127,119,221,.13)}.qzpron-progress{display:flex;align-items:center;gap:10px;margin-bottom:16px}.qzpron-track{flex:1;height:12px;background:#F4F2FD;border:1px solid #E4E1F8;border-radius:999px;overflow:hidden}.qzpron-fill{height:100%;background:linear-gradient(90deg,#F97316,#7F77DD);border-radius:999px}.qzpron-count{min-width:74px;text-align:center;padding:7px 11px;border-radius:999px;background:#7F77DD;color:#fff;font-size:12px;font-weight:900}.qzpron-card{min-height:540px;border:1px solid #EDE9FA;border-radius:30px;background:#fff;padding:18px;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;box-shadow:0 8px 24px rgba(127,119,221,.09)}.qzpron-cue{display:inline-flex;margin-bottom:12px;padding:6px 13px;border-radius:999px;background:#EEEDFE;color:#534AB7;font-size:12px;font-weight:900}.qzpron-image{width:100%;max-width:680px;height:400px;margin-bottom:14px;border-radius:24px;background:#fff;border:1px solid #EDE9FA;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:10px}.qzpron-image img{width:100%;height:100%;object-fit:contain;border-radius:18px}.qzpron-word{max-width:620px;font-family:'Nunito','Segoe UI',sans-serif;font-size:clamp(20px,2.8vw,30px);font-weight:900;line-height:1.18;color:#534AB7;overflow-wrap:anywhere}.qzpron-card.image-only .qzpron-word{display:none}.qzpron-card.text-only .qzpron-image{display:none}.qzpron-card.text-only{justify-content:center}.qzpron-card.text-only .qzpron-word{font-size:clamp(30px,5.4vw,52px)}.qzpron-ph{margin-top:8px;color:#4B5563;font-size:17px;font-weight:800}.qzpron-box{width:100%;max-width:620px;margin-top:10px;border-radius:12px;padding:9px 12px;font-size:13px;font-weight:800;text-align:center}.qzpron-captured{border:1px solid #EDE9FA;background:#fff;color:#534AB7}.qzpron-captured.ok{border-color:#bbf7d0;background:#f0fdf4;color:#166534}.qzpron-captured.bad{border-color:#fecaca;background:#fef2f2;color:#991b1b}.qzpron-feedback{color:#9B94BE}.qzpron-feedback.bad{color:#991b1b}.qzpron-actions{display:flex;justify-content:center;align-items:center;gap:10px;flex-wrap:wrap;margin-top:16px;padding-top:16px;border-top:1px solid #F0EEF8}.qzpron-btn{border:0;border-radius:10px;min-width:clamp(104px,16vw,146px);padding:13px 20px;color:#fff;font-family:'Nunito',sans-serif;font-size:13px;font-weight:900;cursor:pointer;box-shadow:0 6px 18px rgba(127,119,221,.18);transition:filter .15s,transform .15s}.qzpron-btn:hover{filter:brightness(1.07);transform:translateY(-1px)}.qzpron-btn:disabled{opacity:.55;cursor:not-allowed;transform:none;filter:none}.qzpron-purple{background:#7F77DD;box-shadow:0 6px 18px rgba(127,119,221,.18)}.qzpron-orange{background:#F97316;box-shadow:0 6px 18px rgba(249,115,22,.22)}.qzpron-light{background:#fff;color:#7F77DD;border:1px solid #EDE9FA}@media(max-width:640px){.qzpron-holder{margin-top:18px}.qzpron-board{padding:14px;border-radius:26px}.qzpron-card{min-height:460px;padding:14px;border-radius:24px}.qzpron-image{height:320px;border-radius:20px}.qzpron-word{font-size:clamp(18px,5.5vw,28px)}.qzpron-card.text-only .qzpron-word{font-size:clamp(26px,7vw,40px)}.qzpron-actions{display:grid;grid-template-columns:1fr}.qzpron-btn{width:100%}}
</style>
<div id="<?=$prefix?>_holder" class="qzpron-holder" hidden>
 <section class="qzpron-board" data-az-zoom>
  ...
  <div class="qzpron-card <?=$image!==''?'image-only':'text-only'?>">
