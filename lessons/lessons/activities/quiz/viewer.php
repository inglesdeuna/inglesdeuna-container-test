...
$qzLocked=false;$qzCompletedCount=0;$qzHasTeacherUnlock=false;$qzCanRetry=true;
...
$qzAllAttempts=$mode==='result'&&$qzHasDb?qz_load_all_completed_attempts($pdo,$qzStudentId,$unitId,$assignment):[];
