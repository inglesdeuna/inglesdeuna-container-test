...
.mzk-page{width:100%;height:calc(100vh - 44px);min-height:calc(100vh - 44px);padding:6px 10px 8px;display:flex;align-items:stretch;justify-content:center;background:#F8F7FF;box-sizing:border-box}
.mzk-app{width:min(1560px,100%);min-height:0;display:flex;flex-direction:column;gap:8px;margin:0 auto}
...
.mzk-stage{flex:1;min-height:0;background:#fff;border:1px solid #F0EEF8;border-radius:26px;padding:14px 16px 10px;box-shadow:0 8px 40px rgba(127,119,221,.13);width:100%;box-sizing:border-box;display:flex;flex-direction:column;overflow:hidden}
.mzk-play-area{flex:1;min-height:0;display:grid;grid-template-columns:minmax(0,1fr) minmax(150px,210px);gap:clamp(14px,2.4vw,24px);align-items:start}
.mzk-maze-wrap{min-width:0;min-height:0;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:0}
.mzk-maze-wrap svg{display:block;width:100%;height:auto;max-width:100%;max-height:calc(100vh - 210px);object-fit:contain}
.mzk-side-rail{width:100%;display:flex;align-items:flex-start;justify-content:center}
...
#mzkFeedback{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}
#mzkFeedback.good{color:var(--mz-green-dark)}#mzkFeedback.bad{color:#b91c1c}
...
@media(max-width:980px){.mzk-app{width:min(100%,1360px)}.mzk-play-area{gap:10px}.mzk-maze-wrap svg{max-height:calc(100vh - 228px)}}
@media(max-width:760px){.mzk-page{padding:6px}.mzk-topbar{align-items:stretch;flex-direction:column}.mzk-scorebar{min-width:0;width:100%}.mzk-stage{border-radius:20px;padding:8px}.mzk-play-area{grid-template-columns:1fr;gap:14px}.mzk-side-rail{order:-1}.mzk-maze-wrap svg{max-height:calc(100vh - 214px)}.mzk-title{font-size:18px}.mzk-controls{gap:6px}.mzk-btn{padding:9px 12px}}
</style>
<div class="mzk-page"><div class="mzk-app"><div class="mzk-topbar"><div class="mzk-title-block"><div class="mzk-kicker">Maze</div><h1 class="mzk-title"><?php echo htmlspecialchars($viewerTitle, ENT_QUOTES, 'UTF-8'); ?></h1></div><div class="mzk-scorebar"><span class="mzk-score-label">Score</span><div class="mzk-track"><div class="mzk-fill" id="mzkFill" style="width:0%"></div></div><div class="mzk-badge" id="mzkBadge">0 / <?php echo count($activity['path_sequence']); ?></div></div></div><div class="mzk-stage"><div class="mzk-play-area"><div class="mzk-maze-wrap" id="mzkMazeWrap"></div><div class="mzk-side-rail" id="mzkSideRail"></div></div><div id="mzkFeedback" aria-live="polite"></div><div class="mzk-completed-screen" id="mzkCompleted"></div><div class="mzk-controls" id="mzkControls"><button class="mzk-btn secondary" type="button" onclick="mzkRestart()">Restart</button><button class="mzk-btn" type="button" onclick="mzkShowAnswers()">Show Answers</button><button class="mzk-btn next" type="button" onclick="mzkGoNext()" id="mzkNextBtn">Next</button></div></div></div></div>
