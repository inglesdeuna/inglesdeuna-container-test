...
.mzk-play-area{flex:1;min-height:0;display:flex;align-items:stretch;gap:16px}
.mzk-maze-wrap{flex:1;min-width:0;min-height:0;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:0}
.mzk-maze-wrap svg{display:block;width:100%;height:auto;max-width:100%;max-height:calc(100vh - 210px);object-fit:contain}
.mzk-side-rail{flex:0 0 118px;display:flex;align-items:center;justify-content:center}
...
@media(max-width:980px){.mzk-app{width:min(100%,1360px)}.mzk-play-area{gap:10px}.mzk-side-rail{flex-basis:92px}.mzk-maze-wrap svg{max-height:calc(100vh - 228px)}}
@media(max-width:760px){.mzk-page{padding:6px}.mzk-topbar{align-items:stretch;flex-direction:column}.mzk-scorebar{min-width:0;width:100%}.mzk-stage{border-radius:20px;padding:8px}.mzk-play-area{gap:8px}.mzk-side-rail{flex-basis:80px}.mzk-maze-wrap svg{max-height:calc(100vh - 214px)}.mzk-title{font-size:18px}.mzk-controls{gap:6px}.mzk-btn{padding:9px 12px}}
</style>
