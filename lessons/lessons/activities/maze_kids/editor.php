...
<div class="mzke-section"><h3>4. Distractor branches / wall animals</h3><p class="mzke-help">Choose which picture is a dead end and after which correct node it connects.</p><div id="mzkeBranchList"></div><div class="mzke-toolbar"><button type="button" class="mzke-btn-add" onclick="mzkeAddBranch()">+ Add Dead End</button></div></div>
