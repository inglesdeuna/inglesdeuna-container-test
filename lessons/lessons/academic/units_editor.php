...
h1{color:#2563eb}
.card{background:#fff;padding:25px;border-radius:16px;max-width:600px}
input{width:100%;padding:12px;margin-top:10px}
button{margin-top:15px;padding:12px 18px;background:#2563eb;color:#fff;border:none;border-radius:10px;font-weight:700}
.item{background:#fff;padding:12px;border-radius:10px;margin-top:10px;box-shadow:0 4px 8px rgba(0,0,0,.08)}
</style>
</head>
<body>
